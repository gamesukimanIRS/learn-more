		...
		switch(strtolower($command->getName())){
			...
			case "asr":
				if(isset($args[0])){
					...
					$sender->sendMessage("> You have set the timer to " . $args[0] . " min/s. The changes will apply after the next server restart.");
				}else{
			...
			case "restart":
				...
				$sender->sendMessage("> The server will restart in $time");
			break;
